...
Why? Because this way *0xde* will go into the first byte, *0xad* the  second, *0xbe* third and *0xef* in the last byte. This happens because the least significant byte is stored in the leas significant address.
